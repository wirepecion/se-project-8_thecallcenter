...
export default async function ProfileUserCard({ uid }: { uid: string }): Promise<JSX.Element | null> {
    ...
    return (
        <div className="flex items-center justify-between bg-[#4361ee] text-white rounded-2xl p-6 shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-2xl w-full max-w-xl mx-auto h-80">
